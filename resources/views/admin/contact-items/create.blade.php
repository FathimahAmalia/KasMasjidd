        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Tambah Kontak Baru</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('contact-items.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="icon" id="icon" placeholder="bi-whatsapp">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="url" id="url" placeholder="https://wa.me/628123456789">
