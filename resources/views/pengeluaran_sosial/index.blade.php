...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1 text-dark">Pengeluaran Kas Sosial</h4>
            <small class="text-muted">Kelola data pengeluaran dana sosial</small>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('pengeluaran-sosial.store') }}">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jenis_pengeluaran" class="form-control" placeholder="Contoh: Santunan" required>
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-label text-muted small fw-bold">Nominal (Rp)</label>
                            <input type="text" id="nominal" name="nominal" class="form-control fw-bold text-danger" placeholder="0" required inputmode="numeric">
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{ route('pengeluaran-sosial.destroy', $item->id) }}" method="POST" class="d-inline form-hapus">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow rounded-4">
                ...
                <form method="POST" action="{{ route('pengeluaran-sosial.update', $item->id) }}">
                    @csrf
                    @method('PUT')
